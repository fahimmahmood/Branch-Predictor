...
void GSharePredictor::predict(const std::string& pc_address, const std::string& label){
...
void GSharePredictor::update_table(const int& index, const std::string& label, const std::string& prediction){
    if(label =="t"){
...
void GSharePredictor::update_global_history(const std::string& label){
...
void GSharePredictor::generate_val_traces(const std::string& cmd){
    cout << "COMMAND\n";
    cout << cmd << "\n";
    cout << "Output\n";
